...
const RESOURCES = [
  ...
  },
  {
    ...
    actions: [
      ...
      { action: "mark-void",             method: "POST",   path: "/invoices/:id/status/void" },
  ...
  },
  {
    ...
    actions: [
      ...
      { action: "mark-void",              method: "POST",   path: "/retainerinvoices/:id/status/void" },
  ...
  },
  {
    ...
    actions: [
      ...
      { action: "mark-open",                  method: "POST",   path: "/vendorcredits/:id/status/open" },
      { action: "mark-void",                  method: "POST",   path: "/vendorcredits/:id/status/void" },
