...
export async function apiRequest({ method, path, query, body, headers = {}, dryRun, verbose, idempotencyKey, ifMatch, file, fileField = "attachment", version = "0.0.0", showSecrets = false }) {
